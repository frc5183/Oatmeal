...
public class RebootVirgo extends Command {
    ...
    public java.lang.@NotNull String getDocumentation() { return "Used By Trip-kun to reboot Virgo, the server hosting myself and several other programs. This SHOULD automatically start myself." +
            "\nUsage:s!rebootvirgo";}
